...
export const makeSelectIsLoadingRandomImages = (state: State) => state.randomImages.loading;
export const makeSelectLikedImages = (state: State) => state.likedImages.data;
export const makeSelectIsUserLikedImageLoading = (state: State) => state.likedImages.loading;
export const makeSelectHasMoreLikedImages = (state: State) => state.likedImages.hasMore;
...
export const makeSelectCurrentImageIndex = (state: State) => state.currentImageIndex;
